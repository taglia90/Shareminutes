...
<%@ page import="control.GestioneRichieste"%>
...
border-radius: 10em;"
 ...
 %>
				...
				<%
						...
						if (tok != null) {
				%>
				<li class="ultimoMenu"><a
					href="AutenticazioneServlet?to=logout">Logout</a></li>
				<%
					}
				%>
			</ul>
			...
			<ul>
				<li class="current"><a
					href="GestioneUtentiServlet?to=redirectToPaginaProfilo">Profilo
