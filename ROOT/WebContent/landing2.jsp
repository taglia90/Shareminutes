...
<div class="wrapper style1 ">
	<div class="divSlider">
		...
		<div class="fraseLanding">
			Il marketplace dove vendere e comprare attività con altri utenti in
			tutto il mondo. <br> <br> Distinguiti e accendi il tuo
			talento!
		</div>
		<div class="fraseMobile">Frase corta per visualizzazione mobile</div>
	</div>
</div>
