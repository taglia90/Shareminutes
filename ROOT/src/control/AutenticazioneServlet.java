...
public class AutenticazioneServlet extends Servlet {
	...
	private void accessoUtente(HttpServletRequest request,
		...
		try {
			...
			session.setAttribute("isClienteOFornitore", false);
	...
	private void passwordDimenticata(HttpServletRequest request,
		...
		try {
			...
			if (utente != null) {
				...
				String linkReimpostaPassword = "http://www.shareminutes.com/RegistrazioneServlet?to=reimpostaPassword&idUtente="
