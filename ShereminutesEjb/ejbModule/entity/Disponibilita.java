...
public class Disponibilita implements Serializable {
	...
	/*
	 * int disponibilitaLunedìDalle; int disponibilitaLunedìAlle; int
	 * disponibilitaMartedìDalle; int disponibilitaMartedìAlle; int
	 * disponibilitaMercoledìDalle; int disponibilitaMercoledìAlle; int
	 * disponibilitaGiovedìDalle; int disponibilitaGiovedìAlle; int
	 * disponibilitaVenerdìDalle; int disponibilitaVenerdìAlle; int
	...
	/*
	 * @Column(name = "disponibilitaLunedìDalle") public int
	 * getDisponibilitaLunedìDalle() { return disponibilitaLunedìDalle; }
	 * 
	 ...
	 * 
	 * @Column(name = "disponibilitaLunedìAlle") public int
	 * getDisponibilitaLunedìAlle() { return disponibilitaLunedìAlle; }
	 * 
	 * public void setDisponibilitaLunedìAlle(int disponibilitaLunedìAlle) {
	 * this.disponibilitaLunedìAlle = disponibilitaLunedìAlle; }
	 * 
	 * @Column(name = "disponibilitaMartedìDalle") public int
	 * getDisponibilitaMartedìDalle() { return disponibilitaMartedìDalle; }
	 * 
	 ...
	 * 
	 * @Column(name = "disponibilitaMartedìAlle") public int
	 * getDisponibilitaMartedìAlle() { return disponibilitaMartedìAlle; }
	 * 
	 ...
	 * 
	 * @Column(name = "disponibilitaMercoledìDalle") public int
	 * getDisponibilitaMercoledìDalle() { return disponibilitaMercoledìDalle; }
	 * 
	 * public void setDisponibilitaMercoledìDalle(int
	 * disponibilitaMercoledìDalle) { this.disponibilitaMercoledìDalle =
	 * disponibilitaMercoledìDalle; }
	 * 
	 * @Column(name = "disponibilitaMercoledìAlle") public int
	 * getDisponibilitaMercoledìAlle() { return disponibilitaMercoledìAlle; }
	 * 
	 ...
	 * 
	 * @Column(name = "disponibilitaGiovedìDalle") public int
	 * getDisponibilitaGiovedìDalle() { return disponibilitaGiovedìDalle; }
	 * 
	 ...
	 * 
	 * @Column(name = "disponibilitaGiovedìAlle") public int
	 * getDisponibilitaGiovedìAlle() { return disponibilitaGiovedìAlle; }
	 * 
	 ...
	 * 
	 * @Column(name = "disponibilitaVenerdìDalle") public int
	 * getDisponibilitaVenerdìDalle() { return disponibilitaVenerdìDalle; }
	 * 
	 ...
	 * 
	 * @Column(name = "disponibilitaVenerdìAlle") public int
	 * getDisponibilitaVenerdìAlle() { return disponibilitaVenerdìAlle; }
	 * 
	 ...
	 * (giorno.equals("Lunedì") && stringa.equals("dalle")) { return
	 * getDisponibilitaLunedìDalle(); } if (giorno.equals("Lunedì") &&
	 * stringa.equals("alle")) { return getDisponibilitaLunedìAlle(); } if
	 * (giorno.equals("Martedì") && stringa.equals("dalle")) { return
	 * getDisponibilitaMartedìDalle(); } if (giorno.equals("Martedì") &&
	 * stringa.equals("alle")) { return getDisponibilitaMartedìAlle(); } if
	 * (giorno.equals("Mercoledì") && stringa.equals("dalle")) { return
	 * getDisponibilitaMercoledìDalle(); } if (giorno.equals("Mercoledì") &&
	 * stringa.equals("alle")) { return getDisponibilitaMercoledìAlle(); } if
	 * (giorno.equals("Giovedì") && stringa.equals("dalle")) { return
	 * getDisponibilitaGiovedìDalle(); } if (giorno.equals("Giovedì") &&
	 * stringa.equals("alle")) { return getDisponibilitaGiovedìAlle(); } if
	 * (giorno.equals("Venerdì") && stringa.equals("dalle")) { return
	 * getDisponibilitaVenerdìDalle(); } if (giorno.equals("Venerdì") &&
	 * stringa.equals("alle")) { return getDisponibilitaVenerdìAlle(); } if
