...
public class GestioneAbilitaServlet extends Servlet {
	...
	private void modificaAbilita(HttpServletRequest request,
		...
		try {
			...
			GestioneDisponibilitaRemote gestioneDisponibilitaRemote = (GestioneDisponibilitaRemote) PortableRemoteObject
					.narrow(ref4, GestioneDisponibilitaRemote.class);
			...
			int disponibilitaLunedìDalle = Integer.parseInt(mrequest
					.getParameter("disponibilitaLunedìDalle"));
			int disponibilitaLunedìAlle = Integer.parseInt(mrequest
					.getParameter("disponibilitaLunedìAlle"));
			int disponibilitaMartedìDalle = Integer.parseInt(mrequest
					.getParameter("disponibilitaMartedìDalle"));
			int disponibilitaMartedìAlle = Integer.parseInt(mrequest
					.getParameter("disponibilitaMartedìAlle"));
			int disponibilitaMercoledìDalle = Integer.parseInt(mrequest
					.getParameter("disponibilitaMercoledìDalle"));
			int disponibilitaMercoledìAlle = Integer.parseInt(mrequest
					.getParameter("disponibilitaMercoledìAlle"));
			int disponibilitaGiovedìDalle = Integer.parseInt(mrequest
					.getParameter("disponibilitaGiovedìDalle"));
			int disponibilitaGiovedìAlle = Integer.parseInt(mrequest
					.getParameter("disponibilitaGiovedìAlle"));
			int disponibilitaVenerdìDalle = Integer.parseInt(mrequest
					.getParameter("disponibilitaVenerdìDalle"));
			int disponibilitaVenerdìAlle = Integer.parseInt(mrequest
					.getParameter("disponibilitaVenerdìAlle"));
			int disponibilitaSabatoDalle = Integer.parseInt(mrequest
					.getParameter("disponibilitaSabatoDalle"));
			int disponibilitaSabatoAlle = Integer.parseInt(mrequest
					.getParameter("disponibilitaSabatoAlle"));
			int disponibilitaDomenicaDalle = Integer.parseInt(mrequest
					.getParameter("disponibilitaDomenicaDalle"));
			int disponibilitaDomenicaAlle = Integer.parseInt(mrequest
			...
			// convertArrayToString(disponibilita);
			...
			if (mrequest.getParameter("pubblicaAbilita") != null) {
				...
				if (utente.isAdmin()) {
					...
					gestioneDisponibilitaRemote.creaDisponibilita(idAbilita,
							disponibilitaLunedìDalle, disponibilitaLunedìAlle,
							disponibilitaMartedìDalle,
							disponibilitaMartedìAlle,
							disponibilitaMercoledìDalle,
							disponibilitaMercoledìAlle,
							disponibilitaGiovedìDalle,
							disponibilitaGiovedìAlle,
							disponibilitaVenerdìDalle,
							disponibilitaVenerdìAlle, disponibilitaSabatoDalle,
							disponibilitaSabatoAlle,
							disponibilitaDomenicaDalle,
							disponibilitaDomenicaAlle);
					session.setAttribute("Successo",
	...
	private void redirectToPaginaModificaAbilita(HttpServletRequest request,
		...
		try {
			...
			Disponibilita disponibilita = gestioneDisponibilitaRemote
					.getIdDisponibilita(idAbilita);
			 ...
			 * .getDisponibilita())); session.setAttribute("disponibilita",
			 * val);
			 */
			LoginToken tok = (LoginToken) session.getAttribute("LoginToken");
	...
	private void redirectToPaginaProfiloAbilita(HttpServletRequest request,
		...
		try {
			...
			/*
			 * Object ref2 = jndiContext.lookup("GestioneUtenti/remote");
			 * GestioneUtentiRemote gestioneUtentiRemote =
			 * (GestioneUtentiRemote) PortableRemoteObject .narrow(ref2,
			 * GestioneUtentiRemote.class); Object ref3 =
			 * jndiContext.lookup("GestioneTag/remote"); GestioneTagRemote
			 * gestioneTagRemote = (GestioneTagRemote) PortableRemoteObject
			 * .narrow(ref3, GestioneTagRemote.class);
			 */
			if (request.getParameter("idAbilita") == null)
				throw new AbilitaException(
			 ...
			 * List<String> val = Arrays.asList(convertStringToArray(abilita
			 * .getDisponibilita())); session.setAttribute("disponibilita",
			 * val); LoginToken tok = (LoginToken)
			 * session.getAttribute("LoginToken"); Utente utente =
			 * gestioneUtentiRemote.getUtente(tok.getIdUtente());
			 */
